...
namespace SCN.Audio
{
    ...
    public class AudioPlayer : MonoBehaviour
    {
        ...
        public static void Setup()
        {
            ...
            instance.setting = LoadSource.LoadObject<AudioSetting>("Audio setting");
            ...
            , System.Action onDone = null, bool ignoreIfPlaying = false)
        {
            ...
            if (stopAllSound) StopSoundList();
            if (!ignoreIfPlaying) StopSound(aud.NameClip);
            ...
            , System.Action onDone = null, bool ignoreIfPlaying = false)
        {
            ...
            if (stopAllMusic) StopMusicList();
            if (!ignoreIfPlaying) StopMusic(aud.NameClip);
        ...
        , System.Action onDone = null)
        {
            ...
            if (aud.Source.isPlaying) aud.Source.Stop();
            aud.Source.Play();
